...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 29 mars 2026 à 12:34
...
CREATE TABLE `course` (
  ...
  `intervention_type_id` int(11) NOT NULL,
...
(4, 'cour de français', 'cour de communication et expression', '#4792JJ'),
...
CREATE TABLE `module` (
  ...
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `hours_count` int(11) DEFAULT NULL,
...
ALTER TABLE `course`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_course_module` (`module_id`),
  ADD KEY `id_intervention` (`intervention_type_id`);

--
-- Index pour la table `course_instructor`
--
ALTER TABLE `course_instructor`
  ADD PRIMARY KEY (`course_id`,`instructor_id`),
  ADD KEY `id_course_instructor` (`instructor_id`);
