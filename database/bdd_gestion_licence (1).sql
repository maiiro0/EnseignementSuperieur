...
(1, '2026-03-10', '2026-04-10', 1, 4, 0, 'Course 1'),
(2, '2026-03-11', '2026-03-12', 2, 4, 1, 'Course 2'),
(3, '2026-03-13', '2026-03-13', 2, 2, 0, 'Course 3'),
(4, '2026-03-10', '2026-04-10', 12, 8, 0, 'course 4'),
(5, '2026-03-14', '2026-03-14', 1, 2, 1, 'course 5'),
(6, '2026-03-15', '2026-03-15', 5, 7, 0, 'course 6'),
(7, '2026-03-15', '2026-03-15', 8, 4, 1, 'course 7'),
(8, '2026-03-16', '2026-03-16', 8, 3, 0, 'course 8'),
(9, '2026-03-17', '2026-03-17', 9, 6, 1, 'course 9'),
(10, '2026-03-18', '2026-03-18', 1, 2, 1, 'course 10'),
(11, '2026-03-19', '2026-03-19', 8, 1, 0, 'course 11'),
(12, '2026-03-20', '2026-03-20', 8, 1, 0, 'course 12');
...
(1, 'Présentation d\'entreprise', 'Présentation de l\'entreprise et des dernier projet de celle ci. ', 'Jaune'),
(2, 'Conférence ', 'Conférence sur la gestion de projet et de l\'importance des soft skils dans le monde du travail.', 'rouge'),
(3, 'Conférence sur L\'IA', 'conférence sur les bonnes conduites d\'un étudiant avec l\'IA', 'rouge'),
(4, 'cour de français', 'cour de communication et expression', 'bleu'),
(5, 'cour de Maths', 'cour de Mathématique pour l\'informatique', 'bleu'),
(6, 'cour d\'Algorithmie ', 'Cour d\'algorithmie encadré', 'bleu'),
(7, 'Projet', 'Séance sur un Projet', 'violet'),
(8, 'Cour sur Git', 'Apprentissage sur l\'utilisation de git', 'bleu'),
(9, 'Cour sur la gestion de base de données', 'Cour sur la gestion de base de données dans le cadre de projet.', 'bleu'),
(10, 'Conférence sur l\'attitude professionnelle', 'Conférence sur l\'attitude professionnelle à tenir en alternance ou stage', 'rouge'),
(11, 'Présentation de projet', 'Explication du projet et du cahier des charges', 'Jaune'),
(12, 'Conférence l\'importance du travail d\'équipe', 'conférence et atelier sur le thème du travail d\'équipe', 'rouge');
...
(8, '2.1.1', 7, 'Type de varaible', 'Apprentissage des différent de variable et et du \"tryparse\" ', 2, 0),
(9, '2.2', 6, 'Les Constantes en C#', 'Apprentissage de l\'utilisation des constantes en C#', 3, 1),
...
(1, 'chef d\'entreprise', 'elena@gmail.com', 'Longuet', 'Elena', 'guitare'),
(2, 'secrétaire', 'Leo@gmail.com', 'Martin', 'Léo', 'arthur75'),
(3, 'Enseignant', 'Prof@gmail.com', 'Chardron', 'Cassandre', 'lys'),
(4, 'Enseignant', 'Eloane@gmail.com', 'Chardron', 'Eloane', 'xiao'),
(5, 'Enseignant', 'Lilou.chardron@gmail.com', 'Chardron', 'Lilou', 'stage'),
(6, 'Enseignant', 'Elsa@gmail.com', 'Leroy', 'Elsa', 'lilas'),
(7, 'chef d\'entreprise', 'William@gmail.com', 'Gonon', 'William', 'livre'),
(8, 'Enseignant', 'julesgonon@gmail.com', 'Gonon', 'Jules', 'maths'),
(9, 'Enseignant', 'roman@gmail.com', 'Malossane', 'Roman', 'sport'),
(10, 'secrétaire', 'Lilas@gmail.com', 'Dubois', 'Lilas', 'cafe'),
(11, 'chef d\'entreprise', 'Jean@gmail.com', 'Frebour', 'Jean', 'Zelda'),
(12, 'Enseignant', 'Sacha@gmail.com', 'ouadi', 'Sacha', 'pomme');
